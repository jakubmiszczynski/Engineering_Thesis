...
.control
  save all
  dc Vdiff -0.02 0.01 0.000001
  let dVout = deriv(v(out))
  plot v(out) vs Vdiff retraceplot
...
C {../design/opamp_cascode.sym} -740 -260 0 0 {name=x1}
C {corner.sym} -500 -570 0 0 {name=CORNER only_toplevel=true corner=tt}
